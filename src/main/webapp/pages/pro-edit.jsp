...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageContext.request.contextPath}/pro/update"
              method="post">
            <!-- 正文区域 -->
            <section class="content"> <!--产品信息-->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        <c:forEach items="${onePro}" var="one">
                            ...
                            <div class="col-md-2 title">源产地</div>
                            <div class="col-md-4 data">
                                <input type="text" class="form-control" name="productCity"
                                       placeholder="源产地" value="${one.productCity}">
                            </div>
                            <div class="col-md-2 title">产品描述</div>
                            <div class="col-md-4 data">
                                <input type="text" class="form-control" name="proDescription"
                                       placeholder="产品描述" value="${one.proDescription}">
                            </div>
                            <div class="col-md-2 title">产品数量</div>
                            <div class="col-md-4 data">
                                <input type="text" class="form-control" name="numbers"
                                       placeholder="产品数量" value="${one.numbers}">
                            </div>
                        </c:forEach>
                        ...
                        <%--                            </thead>--%>
                        <%--                            <tbody>--%>
                        <%--                            <c:forEach items="${onePro}" var="pro">--%>
                        <%--                                <tr>--%>
                        <%--                                    <td><input name="ids" type="checkbox"></td>--%>
                        <%--                                    <td data-type="">${pro.id}</td>--%>
